...
class LiveSettings(BaseModel):
    ...
    # Random message posting feature
    random_enabled: bool = False
    random_delay: int = 300  # Delay between random messages in seconds (default 5 minutes)
    random_count: int = 5  # Number of random messages to post
    random_total_limit: int = 0  # Total random messages to post (0 for unlimited)
    random_active_sources: List[str] = []  # List of source IDs that have random posting enabled
